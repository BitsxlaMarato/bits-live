      ...
      <div class="panel large">
        ...
        <div>
          ...
          <div>
            <h3 class="margin-bottom">Punt de vista tecnològic</h3>
            <p>
              L'ecografia cardíaca és l'eina utilitzada per diagnosticar la hipertrofia i la disfunció cardíaques. En aquest repte busquem disposar d'una aplicació que ens permeti analitzar els paràmetres ecocardiogràfics referents a la morfologia i la funció del cor de manera objectiva i automatitzada i que ens alerti quan es detecti la presència d'anomalies  en algun dels paràmetres habituals. Et veus amb cor de fer-ho? Et necessitem!
            </p>
          </div>
          <div class="margin-bottom">
            <h3 class="margin-bottom">Punt de vista de la salut</h3>
            <p>
              El funcionament correcte del cor és de vital importància ja que s’encarrega de distribuir la sang a la resta d’òrgans. La hipertensió, l'infart de miocardi i les malalties valvulars entre altres, provoquen una resposta adaptativa del cor que modifica la seva morfologia, remodelant el gruix de les seves parets i disminuint el volum de les seves cavitats. Així, l’habilitat de bombejar correctament la sang a l’organisme es veu reduïda i s’esdevé la insuficiència cardíaca. Aquesta patologia suposa un greu problema de salut en la societat occidental amb un impacte econòmic molt important. Es preveu que tan sols a Estats Units aquesta malaltia pugui arribar a afectar a 8 milions de persones l'any 2030.  Els tractaments actuals són poc efectius per prevenir o frenar el desenvolupament de la malaltia, i fonamentalment van dirigits a millorar la qualitat de vida. Per això, és de gran importància identificar noves dianes terapèutiques en aquesta malaltia i per això és necessari realitzar estudis en models animals.
            </p>
          </div>
          <br>
          <div class="margin-bottom text-centered">
        ...
        <div>
          ...
          <div class="margin-bottom">
            ...
            <p>
              ...
              Les últimes dades revelen que només a Europa es produeixen al voltant de 1,5 milions de trombosis a l'any, produint més de 543.000 morts (el que suposa 1 mort per trombosi cada minut). La trombosi genera una despesa directa, només a Europa, estimat en 3 mil milions d'euros a l'any.
            </p>
          </div>
          <br>
          <div class="margin-bottom text-centered">
